    ...
    <div className="container boxout-container">
      <div className="row">
        <div className="col-12 col-md-6 col-lg-3 boxout">
          <div className="boxout-column">
            <span className="boxout-icon">
              <FontAwesomeIcon icon={["fas", "fa-phone"]} size="2x" />
            </span>
        ...
        <div className="col-12 col-md-6 col-lg-3 boxout">
          <div className="boxout-column">
            <span className="boxout-icon">
              <FontAwesomeIcon icon={["fas", "fa-location-dot"]} size="2x" />
            </span>
        ...
        <div className="col-12 col-md-6 col-lg-3 boxout">
          <div className="boxout-column">
            <span className="boxout-icon">
              <FontAwesomeIcon icon={["fas", "fa-clock-rotate-left"]} size="2x" />
            </span>
        ...
        <div className="col-12 col-md-6 col-lg-3 boxout">
          <div className="boxout-column">
            <span className="boxout-icon">
              <FontAwesomeIcon icon={["fas", "fa-at"]} size="2x" />
            </span>
